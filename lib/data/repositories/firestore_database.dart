...
import 'package:wchange/data/repositories/database.dart';
class FirestoreDatabase extends DatabaseInterface {
  ...
  Future<void> addWithID({
    ...
    await _firestore.collection(collectionPath).doc(idDoc).set(data);
  }
  ...
  Future<Map<String, dynamic>?> getDocWithId({required String colletionName, required String idDoc}) async {
